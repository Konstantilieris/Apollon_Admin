...
import { DataTableRowActions } from "./Table-transport.actions";

export const transportColumns: ColumnDef<any>[] = [
  {
    id: "Transport",
    header: () => {
      return <div className=" text-center">ΣΥΣΤΗΜΑ ΜΕΤΑΦΟΡΩΝ</div>;
    },
    enableSorting: true,
