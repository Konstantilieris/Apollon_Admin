  ...
  return (
    <div className="relative flex w-fit items-center gap-4 rounded-xl">
      ...
      >
        ...
        <span className="relative z-10">Οφειλές</span>
      </button>
      <button
        className={`${TOGGLE_CLASSES} ${
          selected === "paid" ? "text-white" : "text-green-500"
        }`}
        onClick={() => {
          setSelected("paid");
        }}
      >
        ...
        <span className="relative z-10">Πληρωμένες</span>
      </button>
      <div
