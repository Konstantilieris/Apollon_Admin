            ...
            steps={[
              {
                ...
                description: "Εισάγετε τα στοιχεία του Πελάτη",
              },
              {
                title: "Εισαγωγή Κατοικίδιου",
                description: "Εισάγετε τα στοιχεία των κατοικιδιων",
              },
              {
                title: "Επιτυχία",
                description: "Επιτυχής Δημιουργία Λογαριασμού",
              },
            ]}
          />
        </div>
