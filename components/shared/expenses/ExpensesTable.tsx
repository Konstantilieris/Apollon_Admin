    ...
    <Table className="text-dark400_light700 font-noto_sans ">
      ...
      <TableBody className="mt-2">
        {expenses?.map((expense: any) => (
          ...
          >
            <TableCell className="max-w-[250px] pl-4 pr-10 text-base font-semibold ">
              {expense?.category.sub.name}
            </TableCell>
            <TableCell className="ml-4  flex max-w-[500px] justify-center truncate pr-10 text-center text-base font-semibold 2xl:max-w-[600px]">
              {expense?.description}
            </TableCell>
            <TableCell className="pl-4 pr-10  text-base font-semibold ">
              {expense?.amount} €
            </TableCell>
            <TableCell className=" pl-4 pr-10 text-base ">
