...
export function RevenueCard({ className, revenue }: any) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <IconContainer handleSync={handleSync}>
...
const IconContainer = ({
  ...
  return (
    <div
      className="flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-r   from-violet-600 to-indigo-600  p-1 hover:animate-pulse"
      onClick={handleSync}
    >
